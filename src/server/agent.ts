 ...
 *
 * - `COPILOT_MODEL` wins when set (e.g. `anthropic/claude-opus-5`, `openai/gpt-5`, `demo`).
 * - Otherwise the first provider with a key in the environment is used.
...
export function createTravelAgent(): BuiltInAgent {
  ...
  return new BuiltInAgent({
    model: demo ? createDemoTravelModel() : spec,
